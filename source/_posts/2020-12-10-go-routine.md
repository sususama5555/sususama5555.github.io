---
title: Go语言协程 Goroutine
date: 2020-05-18 01:35:41
tags: 
- Golang
- Goroutine
- 协程
...
go中使用`Goroutine`来实现并发concurrently。
...
在函数或方法调用前面加上关键字`go`，您将会同时运行一个新的Goroutine。
...
[GO语言基础进阶教程：Go语言的协程——Goroutine](https://zhuanlan.zhihu.com/p/77205289)